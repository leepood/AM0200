...
<script>
	...
	.then(function(responses) {
		...
		.then(function() {
			...
			.then(function() {
        		basket.require({ url: '<?php echo get_template_directory_uri(); ?>/dist/am0200.js', unique: 0 })
			})
		})
	});
</script>
